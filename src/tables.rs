...
#[rustfmt::skip]
pub const GAMESPY_ENCODE: &[u8; 64] = &[
    ...
    91, // input 62 (0x3E) => '[' (0x5B)
    93, // input 63 (0x3F) => ']' (0x5D)
];
#[rustfmt::skip]
pub const GAMESPY_DECODE: &[u8; 256] = &[
    ...
    62, // input 91 (0x5B char '[') => 62 (0x3E)
    INVALID_VALUE, // input 92 (0x5C)
    63, // input 93 (0x5D char ']') => 63 (0x3F)
